...
const photos = [
  { src: "/dome-1.jpeg", alt: "Ehsan and Sinaan sharing a Tiny Twin matcha" },
  { src: "/dome-2.jpeg", alt: "Playful oversized Tiny Twin matcha scene" },
  { src: "/dome-3.jpeg", alt: "Playful Tiny Twin matcha photo" },
];
